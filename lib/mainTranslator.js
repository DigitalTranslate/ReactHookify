...
function translateToFunctionComp(fileInString, lifecycleTest) {
  ...
  // side effect that will be used to determine whether or not to show a warning in terminal
  if (lifeCycleCheck) {
    lifecycleTest.lifecycle = true
  }
