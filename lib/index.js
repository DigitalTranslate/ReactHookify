    ...
    fs.writeFile(
      ...
      (err) => {
        ...
        if (lifecycleCheck) {
          console.log(
            yellow(
              'WARNING: You are attempting to use React-Hookify on a lifecycle method. There are instances where react hooks do not directly translate to lifecycle methods. Please refer to our documentation for more information: https://react-hookify.herokuapp.com/'
            )
          )
        }
